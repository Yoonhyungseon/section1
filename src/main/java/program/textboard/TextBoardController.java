...
public class TextBoardController {
	...
	**************************************************/
    ...
    public String sitemap(HttpServletRequest request, Model model) throws Exception {
		...
		logger.info("sitemap controller");
...
//		System.out.println(board.toString());
	...
	**************************************************/
	...
	public String getList(Model model) throws Exception {		
		logger.debug("TextBoardController Start");
		logger.info("TextBoardController Start");
		logger.warn("TextBoardController Start");
		logger.error("TextBoardController Start");



		model.addAttribute("goSearch", 0);
		model.addAttribute("listAll", textBoardService.getBoardList());
		logger.debug("TextBoardController End");
